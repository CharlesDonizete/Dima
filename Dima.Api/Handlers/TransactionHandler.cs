...
namespace Dima.Api.Handlers
{
    public class TransactionHandler(AppDbContext context) : ITransactionHandler
    {
        ...
        public async Task<Response<Transaction?>> DeleteAsync(DeleteTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, 500, "Não foi possivel excluir sua transação!");
            }
        }
        ...
        public async Task<PagedResponse<List<Transaction>?>> GetByPeriodAsync(GetTransactionsByPeriodRequest request)
        {
            ...
            {
                return new PagedResponse<List<Transaction>?>(null, 500, "Não foi possível determinar a data de início e término.");
            }
        ...
        public async Task<Response<Transaction?>> UpdateAsync(UpdateTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, 500, "Não foi possivel alterar sua transação!");
            }
        }
    }
}
